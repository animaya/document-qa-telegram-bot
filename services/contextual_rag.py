...
try:
    ...
    logging.getLogger(__name__).warning("Cohere SDK not installed. Reranking will not be available.")
...
class ContextualRAG:
    ...
    async def query(self, user_id: int, query_text: str) -> Tuple[List[Chunk], str]:
        ...
        try:
            ...
            query_embedding = await self.embedding_service.create_embedding(query_text, "query")
